...
dataset = df_input
header = list(dataset.columns)
data = df_input.to_string(index=False, header=False)
#data = dataset.to_numpy().tolist()

sql ="""insert into "XHQ"."ML_PREDICTION_FLENGTH3_Py" 
(RECV_PIECE_ID,RECV_GREEN_LENGTH, PI_MEASLENGTH_MM, FIN_LENGTH_IN_MM, GREEN_DIAMETER, 
FIN_LENGTH_OUT_MM, FIN_TIME_EXIT_S3, BAKESHRINKAGE, GRAPHSHRINKAGE, RECV_COKE, RECV_AOS_CLUSTER,
BAK_FIRING_RECIPE, GRA_SPIN_FORMULANUMBER, RECV_NOMINAL_LENGTH, RECV_NOMINAL_OD, PREDICTION) values (:1, :2, :3, :4,
